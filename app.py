...
if run_calc:
    ...
    # Optional visual indicator of reach build
    
    
    st.info(f"💡 Execution Strategy: Deploying {total_imps_val:,}k impressions over {weeks_on_air} weeks to achieve a {eff_freq_n}+ frequency depth.")
